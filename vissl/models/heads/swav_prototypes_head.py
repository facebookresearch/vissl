...
class SwAVPrototypesHead(nn.Module):
    ...
    Output: List(2D torch.tensor of shape N x nmb_clusters)
    """
    ...
    def __init__(self, model_config, dims, use_bn, nmb_clusters, use_bias=True):
        ...
        Args:
            ...
            nmb_clusters (List(int)): number of prototypes or clusters. Typically 3000.
    ...
    def forward(self, batch):
        ...
        Returns:
            List(2D torch.tensor of shape N x nmb_clusters)
        """
