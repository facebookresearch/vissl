...
html_logo = "_static/img/vissl-logo.png"

# setting custom stylesheets https://stackoverflow.com/a/34420612
html_context = {"css_files": ["_static/css/vissl_theme.css"]}

# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "vissldoc"
...
latex_documents = [
    (master_doc, "vissl.tex", "VISSL Documentation", "vissl contributors", "manual")
]
...
man_pages = [(master_doc, "vissl", "VISSL Documentation", [author], 1)]
